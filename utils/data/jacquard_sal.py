...
class JacquardSalDataset(torch.utils.data.Dataset):
	"""
	Dataset wrapper for the Jacquard dataset
	"""
	def __init__(self, file_path, split=0.9, output_size=300,
		...
		trainids, testids = train_test_split(graspf, train_size=split, shuffle=True, random_state=seed)
