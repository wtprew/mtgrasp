...
def plot_output(rgb_img, depth_img, grasp_q_img, grasp_angle_img, no_grasps=1, grasp_width_img=None, classification=None):
	"""
	...
	if classification is not None:
		fig.suptitle('Predicted label: ' + str(classification))
